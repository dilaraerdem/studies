var Filter = {
  ...
  Actions: {
    ...
    appendToHtmlPerson: () => {
      ...
      for (let i = 0; i < Filter.Status.persons.length; i++) {
        ...
        var personHtml =
          ...
          person.size +
          "</li>" +
          "<li> <a href='#' onclick='Filter.Actions.edit(" +
          i +
          ");'> Düzenle </a> <a href='#' onclick='Filter.Actions.delete(" +
          i +
          ");'> Sil </a> </li>" +
          "</ul>" +
          "</li>";
    ...
    edit: (personIndex) => {
      ...
      Filter.Elements.button.setAttribute(
        "onclick",
        "Filter.Actions.editPerson(" + personIndex + ");"
      );
    },
